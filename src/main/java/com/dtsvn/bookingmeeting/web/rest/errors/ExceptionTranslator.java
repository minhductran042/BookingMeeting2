package com.dtsvn.bookingmeeting.web.rest.errors;

import com.dtsvn.bookingmeeting.service.auth.UsernameAlreadyUsedException;
import com.dtsvn.bookingmeeting.service.auth.EmailAlreadyUsedException;
import com.dtsvn.bookingmeeting.service.auth.InvalidPasswordException;
...
import com.dtsvn.bookingmeeting.web.rest.errors.ErrorConstants;
import com.dtsvn.bookingmeeting.web.rest.errors.BadRequestAlertException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        // Handle service layer exceptions by creating appropriate ProblemDetailWithCause
        if (ex instanceof UsernameAlreadyUsedException) {
            return ProblemDetailWithCauseBuilder.instance()
                .withStatus(HttpStatus.BAD_REQUEST.value())
                .withType(ErrorConstants.LOGIN_ALREADY_USED_TYPE)
                .withTitle("Login name already used!")
                .withDetail("Login name already used!")
                .build();
        }
